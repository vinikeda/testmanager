...
function initTopMenu(&$db)
{
  ...
  $_SESSION['testprojectTopMenu2'] = '';// criado para que eu posa carregar um novo topmenu em formato de vetor sem perder o atual. o que me permite alterar a ordem deles com mais facilidade.
...
function templateConfiguration($template2get=null)
{
  ...
  while($dir!="lib" && $dir!="testlink"){
    ...
    $tcfg = new stdClass();
    $tcfg->template_dir = $last_part;//"{$last_part}/";
