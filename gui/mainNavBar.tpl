			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					{if $gui->grants.testplan_metrics == "yes"}
						...
						-->
						<li><a href="http://localhost/testlink/lib/results/resultsTC.php?format=0&tplan_id={$gui->tplanID}" target="mainframe" method="post">{$labels.href_complete_monitoring_report}</a></li>
