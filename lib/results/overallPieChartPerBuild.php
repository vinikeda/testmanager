...
$totals2 = $metricsMgr->getExecStatusPerBuild($args->tplan_id);
	...
	if(isset($totals2['not_run']))$result['not_run'] = $totals2['not_run'];
	//if(isset($totals2['executed']))$result['executed'] = $totals2['executed'];
	if(isset($totals2['blocked']))$result['blocked'] = $totals2['blocked'];
	if(isset($totals2['failed']))$result['failed'] = $totals2['failed'];
