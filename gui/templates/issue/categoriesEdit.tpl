...
*}
{assign var="managerURL" value="lib/issue/categoriesEdit.php"}
{assign var="cancelAction" value="lib/issue/categoriesView.php"}
...
<h1 class="title">Gerenciar Caregorias</h1>
