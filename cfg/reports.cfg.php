...
define('DOC_FAIL_ONLY_TEST_PLAN_EXECUTION_ON_BUILD', 'fonly_testreport_onb');
define('DOC_PASS_ONLY_TEST_PLAN_EXECUTION_ON_BUILD', 'ponly_testreport_onb');
...
//Gera um relatório dos testes baseado em uma build específica
...
//Gera um relatório dos testes baseado em uma build específica contendo apenas falhas
$tlCfg->reports_list['fail_only_test_report_on_build'] = array( 
	'title' => 'link_fail_only_report_test_report_on_build',
	'url' => 'lib/results/printDocOptions.php?type=' . DOC_FAIL_ONLY_TEST_PLAN_EXECUTION_ON_BUILD,
	'enabled' => 'all',
	'format' => 'format_html,format_pseudo_msword'
);

//Gera um relatório dos testes baseado em uma build específica contendo apenas falhas
$tlCfg->reports_list['pass_only_test_report_on_build'] = array( 
	'title' => 'link_pass_only_report_test_report_on_build',
	'url' => 'lib/results/printDocOptions.php?type=' . DOC_PASS_ONLY_TEST_PLAN_EXECUTION_ON_BUILD,
	'enabled' => 'all',
	'format' => 'format_html,format_pseudo_msword'
);

//Gera um relatório de métricas para um plano de teste
///*
...
//Gera uma guia de acompanhamento
