...
switch($args->doc_type) 
{
  ...
  case DOC_PASS_ONLY_TEST_PLAN_EXECUTION_ON_BUILD:
    ...
    $gui->buildInfoSet = null;
    if( $args->doc_type == DOC_TEST_PLAN_EXECUTION_ON_BUILD || $args->doc_type == DOC_FAIL_ONLY_TEST_PLAN_EXECUTION_ON_BUILD || $args->doc_type == DOC_PASS_ONLY_TEST_PLAN_EXECUTION_ON_BUILD)
    {
...
function init_checkboxes(&$args) 
{
  ...
  switch($args->doc_type) 
  {
    ...
    default:
      ...
      if ($args->doc_type == DOC_TEST_PLAN_EXECUTION || $args->doc_type == DOC_TEST_PLAN_EXECUTION_ON_BUILD || $args->doc_type == DOC_FAIL_ONLY_TEST_PLAN_EXECUTION_ON_BUILD || $args->doc_type == DOC_PASS_ONLY_TEST_PLAN_EXECUTION_ON_BUILD) 
      {
